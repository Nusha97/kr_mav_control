...
class PolyTracker : public kr_trackers_manager::Tracker
{
 ...
 private:
  ...
  bool yaw_set_ = false;
  double YAW_DOT_MAX_PER_SEC = 0.38* M_PI;
  double YAW_DOT_DOT_MAX_PER_SEC = 0.75 * M_PI;
...
kr_mav_msgs::PositionCommand::ConstPtr PolyTracker::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  position_cmd_.jerk.x   = jer(0);
  position_cmd_.jerk.y   = jer(1);
  position_cmd_.jerk.z   = jer(2);
